 ...
 */
GpxParser.prototype.parse = function (gpxstring: string, options: Config) {
 ...
 */
GpxParser.prototype.getElementValue = (parent: Element, needle: string) => {
 ...
 */
GpxParser.prototype.queryDirectSelector = (parent, needle) => {
 ...
 */
GpxParser.prototype.calcDistanceBetween = (wpt1, wpt2) => {
